defmodule NotificationHubWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: NotificationHubWeb.Layouts]

      import Plug.Conn
      import NotificationHubWeb.Gettext
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/notification_hub_web/templates",
        pattern: "**/*"
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {NotificationHubWeb.Layouts, :app}
