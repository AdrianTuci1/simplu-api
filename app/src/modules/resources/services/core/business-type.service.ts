...
export class BusinessTypeService {
   ...
   */
  async getBusinessType(businessId: string, locationId: string): Promise<BusinessType> {
   ...
   */
  isValidResourceForBusiness(businessType: BusinessType, resourceType: string): boolean {
